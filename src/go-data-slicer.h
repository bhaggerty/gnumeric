 ...
 * @param tuple_template - an array of column indices which correspond to 
 ...
 * one column.
 * @param self - This GODataSlicer
 * @param column_number - the column index which corresponds to a 
 ...
 *
 * @param self - this GODataSlicer
 * @return an array of pointers to GODataSlicerTuples
 */
GPtrArray *
